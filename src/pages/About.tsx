    ...
    <main>
      <section className="max-w-4xl mx-auto py-16 px-6">
        ...
        <p className="text-base font-light leading-relaxed text-neutral-500 mb-4">
          We're an independent software engineering studio working with startups
          and established businesses to design, build, and scale their most
          important products.
        </p>
        <p className="text-base font-light leading-relaxed text-neutral-500">
          No bloated teams, no account managers in the middle. You work directly
          with the engineers building your product — which means faster
          decisions, tighter feedback loops, and software that actually reflects
          your needs.
        </p>
